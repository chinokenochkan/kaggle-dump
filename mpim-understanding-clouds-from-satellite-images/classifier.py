...
test_imgs_folder = './data/understanding_cloud_organization/test_images/'
train_imgs_folder = './data/understanding_cloud_organization/train_images/'
num_cores = multiprocessing.cpu_count()

train_df = pd.read_csv('./data/understanding_cloud_organization/train.csv')
train_df.head()
...
train_imgs, val_imgs = train_test_split(train_df['Image'].values,
                                        test_size=0.2,
                                        stratify=train_df['Class'].map(lambda x: str(sorted(list(x)))), random_state=2019)
...
submission = pd.read_csv('./submission_post.csv')
submission.head()
...
submission.to_csv('submission_post_w_classifier.csv', index=None)