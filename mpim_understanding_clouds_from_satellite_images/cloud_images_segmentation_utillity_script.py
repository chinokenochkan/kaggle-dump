...
def get_metrics(model, target_df, df, df_images_dest_path, tresholds, min_mask_sizes, N_CLASSES=4, seed=0,
    ...
    for i in range(0, df.shape[0], 300):
        ...
        for class_index in range(N_CLASSES):
            ...
            for index in range(len(batch_idx)):
                ...
                sample_pred_post = post_process(sample_pred, threshold=tresholds[class_index],
